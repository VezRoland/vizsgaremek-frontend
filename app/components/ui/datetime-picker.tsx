	...
	(
		...
		return (
			<Input
				...
				name={name || picker}
				className={cn(
					"w-[52px] text-center font-mono text-base tabular-nums caret-transparent focus:bg-accent focus:text-accent-foreground [&::-webkit-inner-spin-button]:appearance-none",
					className
				)}
		...
		return (
            ...
            <div className="h-4 w-4 text-muted-foreground">
              {icon || <CalendarIcon/>}
						...
						{displayDate ? (
							displayDate.toLocaleString("default", { dateStyle: "short", timeStyle: "short", hour12: false })
						) : (
